(function (global) {
	global.$_Tawk_AccountKey = '5f35170cb7f44f406e948618';
	...
	(function (x) {
		...
		try {
			...
			(function (a) {
				...
				function b(a) {
					for (var c = [], d = 0, k = a.length, s, e; d < k;) s = a.charCodeAt(d++), 55296 <= s && 56319 >= s && d < k ? (e = a.charCodeAt(d++), 56320 == (e & 64512) ? c.push(((s & 1023) << 10) + (e & 1023) + 65536) : (c.push(s), d--)) : c.push(s);
					return c
				}

				function k(a) {
					var c, k, q, r, u, y, z, A, B, C = [],
						D, Ca, Ba;
					a = b(a);
					D = a.length;
					c = m;
					...
					for ((q = r = C.length) && C.push(p); q < D;) {
						z = s;
						for (y = 0; y < D; ++y) B = a[y], B >= c && B < z && (z = B);
						Ca = q + 1;
			...
			x.addEvent = Tawk_API.addEvent = function (a, c, d) {
				b.sessionHandler.addEvent(a, c, d)
			};
			x.setAttributes = Tawk_API.setAttributes = function (a, c) {
				b.sessionHandler.setAttributes(a, !0, c)
			};
			x.addTags = Tawk_API.addTags = function (a, c) {
				b.sessionHandler.addTags(a, c)
			};
			x.removeTags = Tawk_API.removeTags = function (a, c) {
			...
			(function () {
				...
				TawkClass.extend = function (b) {
					...
					var e = new this;
					a = !1;
					for (var f in b) e[f] = "function" === typeof b[f] && "function" === typeof s[f] && c.test(b[f]) ? function (a, c) {
						return function () {
							var b = this._super;
							this._super = s[a];
			...
			A.prototype.getElementsByClassName =
				function (a, c) {
					...
					e = [];
					b = 0;
					for (k = s.length; b < k; b++) - 1 !== s[b].className.indexOf(c) && e.push(s[b]);
					return e
				};
			...
			A.prototype.transformGreetings = function (a) {
				for (var c = /\[([^)]+)\]/, b = /\(([^)]+)\)/, k = /\[[^\]\(\)]+\]\((\bhttp:\/\/\b|\bhttps:\/\/\b|\bmailto:\b){1}[^\]\(\)]+\)/i, s = "_blank", e = a, f, g; null !== (f = k.exec(e)) && (g = c.exec(f[0]), f = b.exec(f[0]), f[0].indexOf("(mailto:") || (s = "_top"), e = e.replace(g[0] + f[0], '<a target="' + s + '" href="' + f[1] + '" class="link">' + g[1] +
						"</a>"), e !== a););
				return e
			};
			A.prototype.checkWhiteLabelLink = function (a, c, d) {
				var k = 1E4 * Math.random(),
					...
					g, h, l = null,
					l = function () {
						if (c.label !== a.innerHTML || c.url && c.url !== a.href || !c.url && a.href || c.id !== a.id || !f.getElementById(a.id) || c.cssText !== a.style.cssText || n.h(a.innerHTML) !== e.key) s.whiteLabelUnexpectedIssueLogged || (b.loggingHandler.logIncident("White label element has changed unexpectedly", {
								pageId: D.uuid
							}), s.whiteLabelUnexpectedIssueLogged = !0), a.id = c.id, a.innerHTML =
			...
			A.prototype.applyWhiteLabelSettings =
				function (a, c, b) {
					...
					e.whiteLabel() && null !== c.url && (a.target = "_blank");
					a.innerHTML = c.label;
			...
			A.prototype.hasClass = function (a, c) {
				return a.classList ? a.classList.contains(c) : !!a.className.match(RegExp("(\\s|^)" +
					c + "(\\s|$)"))
			};
			...
			A.prototype.updateFontStylesheet = function (a) {
				if (a && (a !== document || e.isPopup)) {
					var c = a.getElementById("lato-fonts"),
						b = a.body;
					n.supportsLatin(e.locale) && !c ? (a.querySelector("head").innerHTML += '<link id="lato-fonts" rel="stylesheet" href="https://fonts.googleapis.com/css?family=Lato:100,100i,300,300i,400,400i,700,700i,900,900i&subset=latin-ext" rel="stylesheet"/>',
						this.addClass(b, "font-lato")) : !n.supportsLatin(e.locale) && c && (c.parentNode.removeChild(c), this.removeClass(b, "font-lato"))
				}
			};
			A.prototype.updateFonts = function () {
				if (b.viewHandler && b.viewHandler.iframeContainer && b.viewHandler.iframeContainer.childViews)
					for (var a = b.viewHandler.iframeContainer.childViews, c = 0; c < a.length; c++) {
						var d = a[c];
			...
			ca.prototype.getPlugins = function () {
				var a, b, d = [];
				a = 0;
				for (b = u.plugins.length; a < b; a++) u.plugins[a].name && d.push(u.plugins[a].name);
				return d
			};
			...
			ca.prototype.getMobileBrowser = function () {
				for (var a = !1, b = u.userAgent, d = Object.keys(Ma), k = 0; !a && k < d.length;) {
					for (var s = d[k], e = 0; e < Ma[s].length; e++)
						if (b.match(Ma[s][e])) {
							a = s;
							break
						}
			...
			wa.prototype.log = function (a, b) {
				var d;
				b && a && (b.uiVersion = "v3", b.buildVersion = "689", b.buildCommit = "bbe6bd87722a4b37837d221bddeab07b632e0463",
					d = {
						type: a,
						data: b
			...
			wa.prototype.postForm = function (a, b) {
				...
				R && (d.open(), d.writeln('<!DOCTYPE html><html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /></head><body><iframe name="form-receiver" id="form-receiver"></iframe></body></html>'),
					d.close());
			...
			Qa.prototype.initAudioPlayer = function () {
				...
				if (da.supported) {
					...
					this.audioContext && (d = function () {
						...
						"ontouchstart" in g && (a = b.viewHandler.chatContainer.elementReferrer, e.isPopup || (c = a.contentWindow ? a.contentWindow : a.contentDocument.defaultView), c ? c.addEventListener("touchstart", d, !1) : a.addEventListener("touchstart", d, !1), g.addEventListener("touchstart", d, !1)))
				}
			};
			...
			var Da, H, xa, Ea, ta = 0,
				...
				Ua = function (a) {
					...
					Da && Da === a ? n.addClass(a, "showWithFade") : (n.addClass(a, "showWithFade"), "undefined" === typeof H ? 20 === ta ? a.innerHTML = b.languageParser.translate("chat", "emoji_error_load") : (0 === ta && Ta(), setTimeout(function () {
						...
						for (var e = 0; e < c.length; e++) b.eventHandler.listen(c[e], b.viewHandler.clickEvent, function (b) {
							b.stopPropagation();
							Xa(a, b)
						}, c[e].id + "OpenTab")
					})))
				...
				Xa = function (a, c) {
					...
					if (s = "max" !== r.chatWindowState() && b.viewHandler.messagePreview ? b.viewHandler.messagePreview.container.getElementById("tab-content") : y && e.isPopup ? b.viewHandler.chatContainer.getElementById("tab-content") : f.container.getElementById("tab-content")) {
						...
						if ("search" === d) s.innerHTML = t["emoji-search-pane"], s = y && e.isPopup ?
			...
			ua.prototype.init = function () {
				...
				this.socket.on("error", function (a) {
					...
					b.loggingHandler.logIncident(e, d);
					c.socket.disconnect();
					c.disconnectHandler()
				});
				...
				this.socket.on("ready", function (a, e, f) {
					...
					c.selfOrigin = a;
					x.connected = !0;
					c.ready || (x.loaded = !0, "undefined" !== typeof $_Tawk_LoadStart && b.loggingHandler.logPerformance({
				...
				function a(a, c) {
					try {
						...
						q.handleError("Unable to emit socket event : " +
							a + " with data : " + JSON.stringify(c), e.fileName, e.lineNumber, e.stack)
					}
				}
				var c = this;
			...
			C.prototype.attachUserEventListener = function (a, c, d, k) {
				var e;
				if (e = d ? this.getElementById(d) : this.elementReferrer) d = a.split(" "), 1 < d.length ? d.forEach(function (a) {
					b.eventHandler.listen(e, a, c, a + k)
				}) : b.eventHandler.listen(e, a, c, k)
			};
			...
			C.prototype.insertCssFile = function (a, c) {
				var d = this.documentRef.getElementsByTagName("head")[0],
					...
					f = this.documentRef.createTextNode(c ? a : b.ResetStyle + "" + a);
				k.appendChild(e);
				d.appendChild(k);
			...
			ha.prototype.addPlaceholderText = function (a, c, d, k, e) {
				e = RegExp("__" + a.toUpperCase() + "_PLACEHOLDER__", "gm");
				a.toUpperCase();
				a = RegExp("__" + a.toUpperCase() + "__", "gm");
				var f = b.languageParser.translate("form", d + "Placeholder");
				ga || c || (c = f);
				f && f !== d + "Placeholder" || (f = c, c = "");
			...
			ha.prototype.addPlaceholderHandler = function () {
				...
				ga || (a = this.formData.fields) && a.forEach(function (a) {
					...
					"input" !== a.type || a.isEnabled && !a.isEnabled() || (f = a.getValue ? a.getValue() : "", "input" === a.type && n.isArray(f) ? f.forEach(function (b, f) {
						k = c.documentRef.getElementById(a.fieldName + f);
						e = b;
						n.togglePlaceholderText(k, e, a.fieldName + f);
						"textarea" !== k.tagName.toLowerCase() || n.trim(k.value) || (k.value = e)
					}) : a.hiddenIE8 || (k = c.documentRef.getElementById(a.fieldName + "Field"), e = b.languageParser.translate("form",
			...
			Y.prototype.buildForm = function () {
				...
				if (null ===
					...
					for (var d = 0, k = e[a + "Options"].fields.length; d < k; d++) {
						var s = {},
							f = e[a + "Options"].fields[d];
						f.id = a + d;
						s.label = f.label;
			...
			Y.prototype.generateDynamicFields = function () {
				for (var a =
						"", b = RegExp("__LABEL__", "gm"), d = RegExp("__ID__", "gm"), k = RegExp("__MAXLENGTH__", "gm"), e = 0, f = this.formData.dynamicFields.length; e < f; e++) {
					var g, h = "",
			...
			Y.prototype.generateRadioOptions = function (a, b) {
				for (var d = "", k = t.radioSelectionType, e = 0, f = b.length; e < f; e++) d += k.replace(/__ID__/gm, a + "radio" + e).replace(/__FIELD_ID__/gm, a).replace(/__VALUE__/gm, b[e]);
				return d
			};
			Y.prototype.generateCheckboxOptions = function (a, b) {
				for (var d = "", k = t.checkboxSelectionType, e = 0, f = b.length; e < f; e++) d += k.replace(/__ID__/gm, a + "check" + e).replace(/__FIELD_ID__/gm, a).replace(/__VALUE__/gm, b[e]);
				return d
			};
			Y.prototype.updateName = function (a) {
				for (var c, d = 0, k = this.formData.dynamicFields.length; d < k; d++) {
					var e = this.formData.dynamicFields[d];
					if ("name" === e.fieldType) {
						c = b.viewHandler.chatContainer.getElementById(e.fieldName + "Field");
						break
					}
				}
				c && (c.value = a)
			...
			E.prototype.toggleUploadsAction = function () {
				...
				c && (e.showUploads() ? (c.style.display = "block", this.container.attachUserEventListener("change", function (c) {
						b.eventHandler.cancelEvent(c);
						c = b.eventHandler.getTargetElement(c).files;
						var d = [],
							e = [];
						if (c && c.length) {
							for (var f = 0; f < c.length; f++) c[f].size > a.maxSizeFileUpload ? d.push(c[f]) : f >= a.maxNumberFileUpload ? e.push(c[f]) : b.viewHandler.startUpload(c[f]);
					...
					var e = [],
						f = [];
					if (c && 0 !== c.length) {
						for (var g = 0; g < c.length; g++) c[g].size > a.maxSizeFileUpload ? e.push(c[g]) : g >= a.maxNumberFileUpload ? f.push(c[g]) : b.viewHandler.startUpload(c[g]);
			...
			E.prototype.toggleRatingAction = function () {
				...
				a && c && (e.showRating() ? (a.style.display = "block", this.container.attachUserEventListener(b.viewHandler.clickEvent,
					function (a) {
			...
			E.prototype.updateMobilePositions = function () {
				var a = {},
					c = e.minimizedDimensions().width,
					d = e.minimizedDimensions().height;
				e.isCenterPositioned() ? (-1 === this.wrapper.className.indexOf("center") && (this.wrapper.className += "center"), a.top = "calc(50% - " + (0.5 * c + 20) + "px) !important", a.bottom = "auto !important", e.isRightPositioned() ?
					(-1 === this.wrapper.className.indexOf("right") && (this.wrapper.className += " right"), a.right = this.offsetX + d + 15 + 100 + "px !important", a.left = "auto !important") : (-1 === this.wrapper.className.indexOf("left") && (this.wrapper.className += " left"), a.left = this.offsetX + d + 15 + 100 + "px !important", a.right = "auto !important")) : (d = b.viewHandler.minifiedBoxHeight * b.viewHandler.zoom + 30, e.isTopPositioned() ? (a.bottom = "auto !important", a.top = d + 30 + "px !important", -1 === this.wrapper.className.indexOf("top") && (this.wrapper.className +=
					" top")) : (a.bottom = d + 30 + "px !important", a.top = "auto !important", -1 === this.wrapper.className.indexOf("bottom") && (this.wrapper.className += " bottom")), e.isRightPositioned() ? (a.right = "10px !important", a.left = "auto !important", -1 === this.wrapper.className.indexOf("right") && (this.wrapper.className += " right")) : (a.right = "auto !important", a.left = "10px !important", -1 === this.wrapper.className.indexOf("left") && (this.wrapper.className += " left")));
			...
			E.prototype.appendCallInfo = function (a) {
				if (!y) {
					...
					var g = null,
						...
						p = "",
						q = null;
					this.container && this.messagePreviewContainer && a && (m = b.languageParser.translate("chat", "missed_visitor_messagePreview"), d = (c = (g = w.agentProfiles[w.profiles[f.urid]]) && g.pi ? r.agentImgUrl + "/" + g.pi : "") ? "url('" + c + "');" : "transparent;", "transparent" !== d && (d += "background-position:0 0;background-size:28px 28px"),
						c = new C(s, null, {
						...
						}]), c.buildView(), e.isTopPositioned() ? this.messagePreviewContainer.insertBefore(c.elementReferrer, this.messagePreviewContainer.getElementsByClassName("message-preview-item")[0]) :
						this.messagePreviewContainer.appendChild(c.elementReferrer), g = c.elementReferrer.getElementsByClassName("btn-icon")[0], m = c.elementReferrer.getElementsByClassName("mp-callIconContainer")[0], a && (g.style.transform = "rotate(135deg)", g.style.top = "1px", m.style.backgroundColor = "#e52f48"), this.container.getElementById("incoming-call") && (this.container.getElementById("incoming-call").style.marginBottom = "10px"), this.prevSenderUid === w.profiles[f.urid] && (p += " hidden-profile"), c.elementReferrer.className += p, c.elementReferrer.setAttribute("data-uid",
							w.profiles[f.urid]), q = c.elementReferrer.getElementsByClassName("mp-callInfoElapsedTime")[0], this.timeIntervalsArr.push({
							messageId: s,
			...
			E.prototype.parseSurvey = function (a, b) {
				var d, k, e, f, g, h, l = a.match(n.regSurvey),
					m = "";
				if (!l) return {
					message: a,
					isSurvey: !1
				...
				d = 0;
				for (k = l.length; d < k; d++) e = l[d].replace(n.regOption, ""), e = e.replace(n.regBr, ""), e = n.trim(e), h = g + d, m += n.escapeTemplateReplacement(t["survey-option"], [{
				...
				a && this.container && (f = a.message, g = a.profileImg ? a.profileImg ? "https://tawk.link/" + a.profileImg : "" : (g = w.agentProfiles[a.ownerId]) && g.pi ? r.agentImgUrl + "/" + g.pi : "", g = g ? "url('" + g + "');" : "transparent;", this.messagePreviewContainer &&
					("undefined" !== typeof H && (f = H.unifyUnicode(f), 0 === f.replace(H.regUnicode, "").trim().length && (l += " emojionly"), f = H.toImage(f)), f = "s" === a.senderType ? this.limitMessageLength(f, 500) : this.limitMessageLength(f, 150), a.data && a.data.file && (f = b.viewHandler.parseUploadedFile(a.data.file)), m = this.parseSurvey(f, q), f = m.message, m = m.isSurvey, d = new C(q, null, {
						...
						(this.container.getElementById("incoming-call").style.marginBottom = "10px"), a.ownerId && this.prevSenderUid === a.ownerId && (l += " hidden-profile"), d.elementReferrer.className += l, d.elementReferrer.setAttribute("data-uid", a.ownerId), s = d.elementReferrer.getElementsByClassName("messageTime")[0], this.timeIntervalsArr.push({
							...
							timestamp: v
						}), this.prevSenderUid = a.ownerId, f = d.elementReferrer.firstElementChild, b.eventHandler.listen(f, b.viewHandler.clickEvent, function () {
							c.removeElement(d.elementReferrer)
						}, "close-" + d.elementReferrer.id), 3 < this.messagePreviewCount && (e.isTopPositioned() ? this.removeElement(this.messagePreviewContainer.getElementsByClassName("message-preview-item")[3]) : this.removeElement(this.messagePreviewContainer.getElementsByClassName("message-preview-item")[0])), c.scrollToBottom(),
			...
			E.prototype.addSurveyHandlers = function (a) {
				var c, d = this;
				this.container && (c = this.container.getElementById(a), c = n.getElementsByTagName(c, "input"), c.forEach(function (c, e) {
			...
			E.prototype.removeAllElements = function () {
				for (var a = null, b = 0, d = e.minimizedDimensions().width,
				...
				if (this.messagePreviewContainer) {
					...
					this.prevSenderUid = "";
					e.isCenterPositioned() && this.container.restyle("top", "calc(50% - " + 0.5 * d + "px) !important");
			...
			E.prototype.toggleEmojiAction = function () {
				...
				e.showEmoji() ? (b.style.display = "block", n.addClass(k, "with-emoji"), d.innerHTML = t.loader, this.container.attachUserEventListener("click", function (b) {
					b.stopPropagation();
			...
			var z = TawkClass.extend({
				...
				appendAgent: function (a) {
					...
					f && (c && l) && (-1 < this.chatContainer.getElementById("greetingsMainContainer").className.indexOf("minimize") && (g.style.display = "none", c.className = "show"), b.agents.agentsCount++, 1 < b.agents.agentsCount || 1 === b.agents.agentsCount && this.mainAgent && this.mainAgent.pid !== a.pid ? d.classList.remove("one-agent") : d.classList.add("one-agent"), 1 === b.agents.agentsCount ? (this.mainAgent = a, b.viewHandler.renderAgentHeader(a.pid), this.renderAgentMinimizedWidget(a.pid)) : (b.viewHandler.renderAgentHeader(a.pid), k.classList.add("multiple-agent")),
						b.viewHandler.openAgentList(), c = t["agent-profile"], d = t["agent-profile-image"], k = t["agent-profile-description"], f = new C("agentProfile-" + a.pid, null, {
							className: "agentWrapper clearfix"
						}, null, f.documentRef), (g = a.pi ? r.agentImgUrl + "/" + a.pi : "") && (h = "background-image : url('" + g + "'); background-position : 0px 0px;"), h += "box-shadow: 0px 0px 0px 1px " + e.headerTxtColor + ";", k = n.escapeTemplateReplacement(k, [{
						...
						]), d = d.replace("__PROFILE_ID__", a.pid).replace("__IMAGE_URL__", h), f.template = n.escapeTemplateReplacement(c, [{
				...
				removeAgent: function (a) {
					var c, d, k, e, g = f.container.elementReferrer ? f.container : null,
						h = g.getElementById("chatWrapper");
					g && (b.agents.agentsCount--, c = g.getElementById("agentProfileContainer"),
						d = g.getElementById("agentProfile-" + a), k = g.getElementById("profileImage-" + a), e = g.getElementById("profileDetail" + a), 0 === b.agents.agentsCount ? (b.viewHandler.clearAgentHeader(), this.clearAgentFooter()) : 1 === b.agents.agentsCount && (b.eventHandler.removeEventHandler(c, "click", this.expandAgentList), g.getElementById("headerAccountStateContainer").classList.remove("multiple-agent")), 0 < b.agents.agentsCount && this.mainAgent.pid === a && (this.mainAgent = w.agentProfiles[Object.keys(w.agentProfiles)[0]], this.renderAgentMinimizedWidget(this.mainAgent.pid)),
						d && d.parentNode.removeChild(d), k && (k.parentNode && k.parentNode.removeChild(k), c.style.width = 1 >= b.agents.agentsCount ? "" : 30 * b.agents.agentsCount - 10 * (b.agents.agentsCount - 1) + "px"), e && e.parentNode && e.parentNode.removeChild(e), 1 === b.agents.agentsCount && (this.renderAgentMinimizedWidget(this.mainAgent.pid), h.className = "single-agent", b.viewHandler.calculateOwnerNameAndMessageTimeSizeAll(), b.viewHandler.messagePreview && b.viewHandler.messagePreview.setStyleToSingleAgent()));
				...
				renderAgentMinimizedWidget: function (a) {
					...
					d && (this.chatContainer && a) && (c = w.agentProfiles[a], a = d.getElementById("tawkchat-status-agent-container"), iconContainer = d.getElementById("tawkchat-status-icon-container"), f = d.getElementById("agent-profile-image"), tawkStatusMessage = d.getElementById("tawkchat-status-text-container"),
						profileDetails = d.getElementById("min-agent-profile-details"), k = d.getElementById("tawkchat-chat-indicator"), a && (this.clearAgentFooter(), d = c.pi ? r.agentImgUrl + "/" + c.pi : "", f.style.backgroundImage = d ? "url('" + d + "')" : "", f.style.boxShadow = "0px 0px 0px 1px " + e.headerTxtColor, a.className += "appear", profileDetails && (profileDetails.innerHTML = '<p class="name">' + c.n + '</p><p class="position">' + c.pst + "</p>"), tawkStatusMessage && e.isDesktopRectangle() && (tawkStatusMessage.style.display = "none"), k && "block" === k.style.display &&
							b.viewHandler.handleIndicatorToggle(!0)))
				},
				clearAgentHeader: function () {},
				handleAcknowledgment: function (a) {
					var c, d, k, e, f, g, h, l, m = this.chatContainer;
					if (m && a.messageId && (e = m.getElementById(a.messageId))) {
						k = e.parentNode;
						d = 0;
						for (var p = e.childNodes.length; d < p; d++) {
							var q = e.childNodes[d]; - 1 !== q.className.indexOf("messageBody") && (c = n.getElementsByClassName(q, "messageWrapper"), l = n.getElementsByClassName(q, "messageStatusContainer"))
						}
						c && (c.length && l && l.length) && (l = l[0], c = c[0], a.error ? l && (k = t["chat-resend-link"].replace("__MESSAGE_ID__",
							a.messageId).replace("__NOT_DELIVERED__", b.languageParser.translate("chat", "resend")).replace("__FAILED__", b.languageParser.translate("chat", "failed")), c.className = "messageWrapper error", l.className = "messageStatusContainer errorInMessage", l.innerHTML = k, f = n.rawDecode(c.childNodes[0].textContent || c.childNodes[0].innerText), this.scrollToBottom(), h = b.eventHandler.listen(l, b.viewHandler.clickEvent, function (d) {
						...
						}, "resend" + a.messageId + "click")) : (d = b.chatHandler.messages[a.order], b.viewHandler.addWaitTime(), k.removeChild(e), b.chatHandler.prepareMessage(d, !0, !1, !0)))
					}
				},
				...
				appendMessage: function (a) {
					...
					b.chatHandler.noRedraw || (b.viewHandler.isMaximized || e.isEmbedded || e.isPopup || y || "v" === m || "c" !== a.type) || (e.hideWidgetOnLoad && "max" === e.onClickAction ? (b.viewHandler.userAction = !1, b.sessionHandler.notifyWindowState("max")) : b.viewHandler.messagePreview && b.viewHandler.messagePreview.show ? b.viewHandler.messagePreview.show(b.viewHandler.indicator.unansweredMessages +
						1, a) : b.viewHandler.messagePreview || (this.hasBeenMaximizedOnce || "max" !== e.onClickAction || b.chatHandler.agentHasMessaged) || (b.viewHandler.userAction = !1, b.sessionHandler.notifyWindowState("max"), this.hasBeenMaximizedOnce = !0));
					...
					"c" === a.type ? (b.chatHandler.lastMessageOwner = "s" === m ? "server" : a.isPending ? b.chatHandler.lastMessageOwner : a.ownerId, "a" === m || "s" === m ? ("a" === m && (b.chatHandler.agentHasMessaged = !0, this.removeWaitTime()), d = n.escapeTemplateReplacement(x["chat-message-owner-agent"], [{
							...
							d = n.isGeneratedName(D.name()) && x["chat-message-owner-visitor"] ? n.escapeTemplateReplacement(x["chat-message-owner-visitor"], [{
								...
								textReplace: k
							}]), a.data && "v" === m && (f = f.replace("messageBody", "messageBody file")), "s" === m && (f = f.replace("ownerNameContainer", "ownerNameContainer trigger"), f = f.replace("messageBody", "messageBody trigger"))) :
						"n" === a.type && (b.chatHandler.lastMessageOwner = "notif", a.isRtcError ? (k = "video" === a.rtcType ? b.languageParser.translate("chat", "video_call_error") : "screen" === a.rtcType ? b.languageParser.translate("chat", "screen_share_error") : b.languageParser.translate("chat", "voice_call_error"), f = n.escapeTemplateReplacement(t.noWebrtc, [{
							placeholder: "__MESSAGE__",
							textReplace: d
						}, {
				...
				updateViewByStatus: function (a) {
					...
					"online" === a || "away" === a ? (e.showConsentForm ? b.formHandler.openForm("consentForm") : e.showPreChatForm && !r.prechatFormSubmitted() && b.formHandler.openForm("preChatForm"), this.showWidget(), p && (b.viewHandler.isMaximized || p.showBubble())) : "offline" === a && (e.hideWidgetOnOffline ? this.hideWidget() : (b.formHandler.openForm(e.showConsentForm ? "consentForm" : "offlineForm"), this.showWidget()), p && (p.hideBubble(), this.messagePreview && this.messagePreview.removeAllElements()))
				}
			});
			...
			z.prototype.addProfileDetail = function (a) {
				var c, d, k, e = this.chatContainer.getElementById("agentProfileContainer");
			...
			z.prototype.renderAgentWithPosition = function (a) {
				...
				b && (e && a) && (a = w.agentProfiles[a], b = new C("profileDetail" + a.pid, null, {
			...
			z.prototype.renderAgentHeader = function (a) {
				...
				f && (g && a) && (c = w.agentProfiles[a], (d = c.pi ? r.agentImgUrl + "/" + c.pi : "") && (k = "background-image : url('" + d + "'); background-position : 0px 0px;z-index: " + (7 - b.agents.agentsCount) + ";"), k += "box-shadow: 0px 0px 0px 1px " + e.headerTxtColor + ";", c = new C("profileImage-" + c.pid, k, {
			...
			z.prototype.calculateOwnerNameAndMessageTimeSizeAll = function () {
				...
				[].forEach.call(a.getElementsByClassName("agentChatContainer"), function (a) {
					...
					c && (d && e && k) && (1 < b.agents.agentsCount && e.offsetWidth < d.offsetWidth + c.offsetWidth ?
			...
			z.prototype.addSurveyHandlers =
				function (a) {
					var c, d = this;
					this.chatContainer && (c = this.chatContainer.getElementById(a), c = n.getElementsByTagName(c, "input"), c.forEach(function (c, e) {
			...
			z.prototype.isChatScrollbar = function () {
				...
				if (this.chatContainer && this.chatContainer.elementReferrer && (a = this.chatContainer.getElementById("chatContainer"))) return a.scrollHeight >
					this.getViewportDimensions(e.isPopup).height - 139
			};
			z.prototype.addWaitTime = function () {
				var a, c, d;
				!b.chatHandler.agentHasMessaged && e.showWaitTime && (c = this.chatContainer.getElementById("greetingsContent"), (a = this.chatContainer.getElementById("greetingsWaitTime")) && c && (d = Math.ceil(r.waitTime / 6E4), d = b.languageParser.translate("chat", "messageQueuedText", {
					t: d,
					strongStart: "<b>",
					strongEnd: "</b>"
			...
			z.prototype.appendAgentIsTypingElement = function (a) {
				var b, d, k = this.ifScrollbarDown(),
					e = w.agentProfiles[a];
				this.chatContainer && (d = e && e.pi ? r.agentImgUrl + "/" + e.pi : "", e.strongStart = "<b>", e.strongEnd = "</b>", b = t["agent-typing"], b = n.escapeTemplateReplacement(b, [{
					placeholder: "__MESSAGE_ID__",
					textReplace: a
				}, {
			...
			z.prototype.changeRating = function (a) {
				var c = "c";
				this.chatContainer && (0 > a ? a = e.showEmoji() && "undefined" !== typeof H ? ":thumbsdown_tone2:" : "&#128078;" : 0 < a ? a = e.showEmoji() && "undefined" !== typeof H ? ":thumbsup_tone2:" : "&#128077;" : (a = b.languageParser.translate("chat", "remove_rate"), c = "n"), b.viewHandler.appendMessage({
					message: a,
					type: c,
					time: new Date,
					senderType: "v",
			...
			z.prototype.notifiyDepartmentIsNotOnline = function (a, c) {
				var d, k, e = this.chatContainer;
				e && (d = e.getElementById("chatWrapper")) &&
			...
			z.prototype.setDivider = function (a, c, d) {
				var k, f, g, h = this;
				!this.chatContainer.documentRef.getElementById("newMessageDivider") && (g = this.chatContainer.documentRef.getElementById("chatWrapper"), f = new C("newMessageDivider"), f.template = n.escapeTemplateReplacement(c, [{
					placeholder: /__NEW_MESSAGES__/gm,
					textReplace: b.languageParser.translate("chat", "newMessages").toUpperCase()
				}]), f.buildView(), g.insertBefore(f.elementReferrer, d.elementReferrer), !n.chatElementInView(f.elementReferrer) && (b.viewHandler.isMaximized || e.isPopup || e.isEmbedded) && (k = this.chatContainer.documentRef.getElementById("newMessagesBar"))) && (k.className = "visible", b.eventHandler.listen(k, this.clickEvent, function () {
					...
					f.onload = function () {
						...
						if (h) {
							...
							if (!b.viewHandler.isMaximized && d.messagePreview) {
								...
								if (m = d.messagePreview.container.getElementById("placeholder-" + a.name)) l.appendChild(f), l.className = "clearfix", m.parentNode.insertBefore(l, m), m.parentNode.removeChild(m);
			...
			z.prototype.startUpload = function (a) {
				...
				c = a.name || a.fileName;
				d = n.getElementsByClassName(e.chatContainer.elementReferrer,
					"upload-error");
				if (d.length)
					for (var h = 0; h < d.length; h++) d[h].parentNode.removeChild(d[h]);
				b.fileUploadHandler.getUploadHandler(function (d) {
					var h;
					d.handle ? (h = d.handle, f = n.escapeTemplateReplacement(f, [{
					...
					}]), e.chatContainer.getElementById("chatWrapper").innerHTML += f, g && e.scrollToBottom(), b.fileUploadHandler.uploadFile(h,
						a, c,
						function (b, d) {
							k.value = "";
							b.success || e.handleUploadError(a, c, h, d)
						})) : (e.handleUploadError(a, c, h), k.value = "")
				})
			};
			...
			z.prototype.applyWhiteLabelSettings = function () {
				...
				this.chatContainer && (a = this.chatContainer.documentRef.getElementById(this.tawktoLinkName), b = this.chatContainer.documentRef.getElementById(this.bottomContainerName),
					...
					}, e.whiteLabel() ? (d.url = e.whiteLabel().url || null, d.label = n.transformLabel(n.rawEncode(e.whiteLabel().label)) || null, d.textColor = e.whiteLabel().textColor || "#000000") : (d.url = "javascript:void(0);", d.label = t["default-branding"]), null === d.label ? (a = this.chatContainer.documentRef.getElementById("contentContainer"), a.className += "no-branding", b.parentNode.removeChild(b)) : (n.insertRandomTagsBeforeAndAfter(b,
			...
			z.prototype.showCallRequest = function (a, c, d, k) {
				...
				g || (c = this.ifScrollbarDown(), b.chatHandler.webrtcWin && !b.chatHandler.webrtcWin.closed ? b.chatHandler.webrtcWin.focus() : (g = (k = w.agentProfiles[w.profiles[k.urid]]) &&
					k.pi ? r.agentImgUrl + "/" + k.pi : "default", f = f.replace(/__IMAGE_URL__/, g ? "url('" + g + "');" : "transparent;"), f = f.replace(/__INCOMING_CALL__/, b.languageParser.translate("chat", "incoming_call_message", {
						name: k.n
					})), f = f.replace(/__ACCEPT_CALL__/, b.languageParser.translate("chat", "accept_call")).replace(/__DECLINE_CALL__/, b.languageParser.translate("chat", "decline_call")), clearTimeout(this.incomingCallTimeout), g = new C("incoming-call"), g.template = f, g.buildView(), f = this.chatContainer.getElementById("chatContainer"),
					k = f.parentNode, f && k && (k.insertBefore(g.elementReferrer, f), f = this.chatContainer.getElementById("accept-call"), k = this.chatContainer.getElementById("decline-call"), c && this.scrollToBottom(), b.eventHandler.listen(f, this.clickEvent, function () {
						...
						this.incomingCallTimeout = setTimeout(function () {
							h.removeCallRequest()
						}, l), e.isPopup || (b.viewHandler.isMaximized || e.isEmbedded) || (b.viewHandler.indicator.show(), b.viewHandler.messagePreview && b.viewHandler.messagePreview.show(b.viewHandler.indicator.unansweredMessages, null, d)), b.audioPlayer.play("chat_sound"))))
			};
			...
			z.prototype.subscribeCallUpdate = function (a, c) {
				...
				e = n.getElementsByClassName(d.elementReferrer, "callInfoContainer");
				f = n.getElementsByClassName(d.elementReferrer, "callIconWrapper");
				...
				b.socketManager.sendToConnector("getCallStatus", {
					...
					p ? (e && e.length && (e[0].style.display =
			...
			z.prototype.updateCallView = function (a, c) {
				...
				k.ver > a.ver || (g = this.ifScrollbarDown(), k = k.callView, l = k.elementReferrer.getElementsByClassName("btn-icon")[0], callIconContainerEl = k.elementReferrer.getElementsByClassName("callIconContainer")[0], callIconContainerEl.style.backgroundColor = "#47ca2b", "ringing" === a.stts ? ("v" !== a.cllr.t && this.showCallRequest(a.clid, a.rt, a.so, a.cllr), d =
					...
					null, l), h || e ? (d = e ? b.languageParser.translate("chat", "rejected_call") : b.languageParser.translate("chat", "missed_" + ("v" === a.cllr.t ? "agent" : "visitor")), e = b.languageParser.translate("chat", "call_started_on", {
					startedOn: f
				})) : (e = n.getTimeDifference(a.so, a.eo), d = b.languageParser.translate("chat", "completed_call"), e = b.languageParser.translate("chat", "call_end_details", {
					startedOn: f,
					duration: e
			...
			z.prototype.toggleGreetingsView = function (a) {
				var c = this.chatContainer.getElementById("chatContainer"),
					...
					e = Math.floor(c.clientHeight);
				a || k === e || 5 >= k - e ? 0 === c.scrollTop && -1 !== d.className.indexOf("minimize") && (d.className = d.className.replace(" minimize", ""), this.chatContainer.getElementById("agentProfileContainer").className = "", 1 === b.agents.agentsCount && this.chatContainer.getElementById("headerAccountStateContainer").classList.remove("multiple-agent"), this.chatContainer.getElementById("shortMessage").style.display = "block") : -1 === d.className.indexOf("minimize") && (d.className += " minimize", this.chatContainer.getElementById("agentProfileContainer").className =
			...
			z.prototype.checkSeenMessageViewport = function () {
				...
				if (0 !== this.unseenMessages.length) {
					for (var k = 0; k < this.unseenMessages.length; k++) {
						...
						var e = this.chatContainer.getElementById(d);
						e && n.chatElementInView(e) && (c = b.chatHandler.getMessageObjectById(d));
			...
			L.prototype.openForm = function (a) {
				...
				if (l && this.currentForm !== a && h) {
					...
					b.viewHandler.chatContainer.attachUserEventListener(a, function (a) {
							...
							b || c === e || 5 >= c - e ? 0 === d.scrollTop && -1 !== k.className.indexOf("minimize") && (k.className = k.className.replace(" minimize", "")) : -1 === k.className.indexOf("minimize") && (k.className += " minimize")
						}, "formFieldsContainer",
						"formContainerScroll");
			...
			L.prototype.resize =
				function () {
					...
					null !== this.formView && y && (k = b.viewHandler.chatContainer.getElementById("formContainer"), d = b.viewHandler.chatContainer.getElementById("formInnerHeight"), e = b.viewHandler.chatContainer.getElementById("headerBoxWrapper"), k && (a = n.getElementsByClassName(k, "formMessageField"), c = n.getElementsByClassName(k, "longFormContainer"), a && (a.length && c && c.length) && (a = n.getElementsByClassName(k, "longFormBottomContainer")[0].clientHeight, c[0].style.height = b.viewHandler.iframeContainer.clientHeight -
						e.clientHeight - a + "px"), !d || "android" !== y && "android2" !== y && "android2.3" !== y || (d.style.overflow = "hidden", b.viewHandler.addOverflowScroll(d))))
				};
						...
						c && ("textarea" !== c.nodeName.toLowerCase() && b.eventHandler.listen(c, "keypress", function (a) {
							...
							function (a) {
								13 !== a.keyCode && setTimeout(function () {
									"" !== k.innerHTML && (k.innerHTML = "", k.style.display = "none", e.style.display = "none", c.parentNode.className = c.parentNode.className.replace(" error", ""))
								}, 1)
				...
				if (this.formView) return a = this.formView.formData.fields || [], this.formView.formData.dynamicFields && (a = this.formView.formData.dynamicFields), a.forEach(function (a) {
					...
					if ("additionalQuestion" ===
						...
						formLabelEl = f.parentElement.parentElement.getElementsByClassName("form-field-label")[0], errorIconEl = b.viewHandler.chatContainer.getElementById(a.fieldName + "FieldErrorIcon"), m = "choice" === a.fieldType ? e.getSelectedCheckbox(m, a.isRequired) : e.getSelectedRadio(m, a.isRequired), h.innerHTML = "", h.style.display = "none", errorIconEl.style.display = "none", f.className = f.className.replace("error", ""), null === m ? (k++, l = !1, h.innerHTML = b.languageParser.translate("form", a.languageKey + "ErrorMessage"), h.style.display = "block",
							errorIconEl.style.display = "block", f.className += " error", formLabelEl.style.color = "#e52f48") : (formLabelEl.style.color = "#707070", d[a.fieldName] = m);
					else {
						...
						l ? d[a.fieldName] = f : (k++, h.innerHTML = b.languageParser.translate("form", a.languageKey + "ErrorMessage"), h.style.display = "block", errorIconEl.style.display = "block", g.parentNode.className += " error")
					}
					c || l || (c = g)
			...
			L.prototype.getSelectedCheckbox = function (a, b) {
				for (var d = [], k = 0, e = a.length; k < e; k++) a[k].checked && d.push(a[k].value);
				return !d.length && b ? null : d
			};
			L.prototype.getSelectedRadio = function (a, b) {
				for (var d = "", k = 0, e = a.length; k < e; k++)
					if (a[k].checked) {
						d =
							a[k].value;
						break
			...
			M.prototype.bubbleSettingsChanged = function () {
				...
				b && (b.viewHandler && b.viewHandler.iframeContainer && b.viewHandler.iframeContainer.elementReferrer) && (a && (a.type && "default" !== a.type || this.bubbleContainer.elementReferrer &&
					this.bubbleContainer.insertCssFile(".bubble-text-color{color:" + (e.chatBubble() ? e.chatBubble().fgc : "#ffffff") + ";}", !0), a && (this.bubbleContainer || (this.bubbleContainer = new Q(n.getRandomName(), n.getGenericStyle({
						...
						minheight: "85px",
						minwidth: "146px"
					}), ba, "iframe")), this.bubbleContainer.elementReferrer || (b.viewHandler.iframeContainer.elementReferrer.appendChild(this.bubbleContainer.buildView(), !0), this.bubbleContainer.buildIframe(b.MinifiedStyle + e.minStyle(), !0)))), this.createBubble(), this.attachBubbleEvents())
			};
			...
			M.prototype.widgetPositonChanged = function () {
				...
				e.isCenterPositioned() ? (e.isDesktopRectangle() &&
					...
					"px) !important", a.bottom = "auto !important") : (a = n.getRotateStyling("0", "0"), a.margin = "0px !important", e.isTopPositioned() ? (a.top = d + "px !important", a.bottom = "auto !important", bodyClassName = " top ") : (a.top = "auto !important", a.bottom = d + "px !important", bodyClassName = " bottom "), e.isRightPositioned() ? (bodyClassName += " right ", a.right = b + "px !important", a.left = "auto !important") : (bodyClassName += " left ", a.left = b + "px !important", a.right = "auto !important"));
				this.container.massRestyle(a)
			};
			...
			M.prototype.calculateBubblePositioning = function (a, b, d, k, f, g, h) {
				...
				if (e.isCenterPositioned()) {
					...
					p = -0.5 * b;
					q = k;
					0 === g ? (l = "gallery" === e.chatBubble().type ? 0 : 0.5 * (l - b), d += "px !important") : "gallery" === e.chatBubble().type ? (q = l = 0, d = -1 * (0.5 * (a - b) - k) + "px !important") : (l = 0.5 * (l - a), d = -1 * (0.5 * (a - b) - d) + "px !important");
					m = n.getRotateStyling(g, "49%");
					e.isRightPositioned() ? (m.right = d, m.left = "auto !important") : (m.left = d, m.right = "auto !important");
					m.top = "50% !important";
					...
					" top ") : (m.bottom = k + "px !important", m.top = "auto !important", h += " bottom "), e.isRightPositioned() ? (m.right = d + "px !important", m.left = "auto !important", h += " right ") : (m.left = d + "px !important", m.right = "auto !important", h += " left ");
			...
			M.prototype.createDefaultBubble = function () {
				...
				if (a || b) b = n.getElementsByTagName(this.bubbleContainer.documentRef, "body")[0], b.innerHTML = t["tawkchat-chat-bubble-canvas"], a && this.createCanvasChatBubble(), a = this.bubbleContainer.getElementById("tawkchat-chat-bubble-text"), a.innerHTML = e.chatBubble().txt, a.style.color = e.chatBubble().fgc,
					e.isCenterPositioned() ? (e.isRightPositioned() ? (d = -90, k -= 10, e.isRTL() && (k = e.minimizedDimensions().width - 146)) : (d = 90, k = e.isDesktopRectangle() ? e.minimizedDimensions().width - 146 + 10 : 10, e.isRTL() && (k = 0)), a = e.minimizedDimensions().height + this.offsetX + 2) : (k = e.minimizedDimensions().height + this.offsetY + 2, a = !e.isRightPositioned() && !e.isRTL() || e.isRightPositioned() && e.isRTL() ? e.isDesktopRectangle() ? e.minimizedDimensions().width - 146 + 16 : 10 : 0), e.isRTL() && (f += " rtl-direction"), this.calculateBubblePositioning(146,
						85, a, k, 0, d, f)
			};
			M.prototype.createImageBubble = function () {
				...
				"gallery" === f.type ? (b = parseInt(f.name, 10), k = 22 === b, e.isDesktopRectangle() || (b += "-r"), e.isCenterPositioned() ? (b += e.isRightPositioned() ? "-cr" : "-cl", e.isDesktopRectangle()) : b = e.isTopPositioned() ? b + (e.isRightPositioned() ? "-tr" : "-tl") : b + (e.isRightPositioned() ? "-br" : "-bl"), a = " gallery ", b = "https://static-v.tawk.to/a-v3/images/bubbles/" +
					b + (k ? ".png" : ".svg"), e.isCenterPositioned() && 0 === f.rotate && (a += " center-right"), d.innerHTML = n.escapeTemplateReplacement(t["tawkchat-chat-bubble-gallery"], [{
						placeholder: "__IMAGE_SRC__",
						textReplace: b
					}, {
						placeholder: "__IMAGE_SIZE__",
						textReplace: "width:" + f.width + "px; height:" + f.height + "px;"
					}])) : (a = " upload ", b = "https://tawk.link/" + e.chatBubble().name, d.innerHTML = n.escapeTemplateReplacement(t["tawkchat-chat-bubble-upload"], [{
					placeholder: "__IMAGE_SRC__",
					textReplace: b
				}]));
				e.isTopPositioned() || e.isCenterPositioned() ?
					(h += f.topOffset, e.isCenterPositioned() && 0 === f.rotate && (h -= 16)) : h += f.bottomOffset;
				d = e.isRightPositioned() ? f.rightOffset : f.leftOffset;
				e.isCenterPositioned() && 0 !== f.rotate && (d = "gallery" === f.type ? d - 3 : d + 2);
				this.calculateBubblePositioning(f.width, g, d, h, f.zIndex, f.rotate, a)
			};
			...
			M.prototype.agentBarChanged = function (a) {
				...
				e.hideWidget || (this.container.massRestyle({
					...
					}), h = R && 10 > O, closeIconWidth = 16, minWidth = e.minimizedDimensions().width, minHeight = e.minimizedDimensions().height, b = e.chatBubble(), d = a - minHeight, l = b.rotate, b.type && "default" !== b.type ? (k = b.topOffset, f = b.bottomOffset, bubbleWidth = b.width, bubbleContainerHeight = b.height + closeIconWidth, g = e.isRightPositioned() ?
						b.rightOffset : b.leftOffset) : (bubbleWidth = 146, bubbleContainerHeight = 85, e.isCenterPositioned() ? (g = minHeight + 2, l = e.isRightPositioned() ? -90 : 90) : (k = minHeight + 2, f = minHeight + 2, g = e.isRightPositioned() ? 0 : minWidth - bubbleWidth + closeIconWidth)), e.isCenterPositioned() ? (k = -0.5 * minWidth + 0.5 * a + "px !important", g += d, d = 0 === l ? g + "px !important" : -1 * (0.5 * (bubbleWidth - bubbleContainerHeight) - g) + "px !important", e.isRightPositioned() ? (this.container.restyle("right", k), m.right = d, h && (this.container.restyle("right", a - minWidth +
						"px !important"), 0 !== l && (m.right = g - (bubbleWidth - bubbleContainerHeight) + "px !important"))) : e.isCenterPositioned() || (this.container.restyle("left", k), m.left = d, h && (this.container.restyle("left", "0px !important"), 0 !== b.rotate && (m.left = g + "px !important"))), h ? this.container.restyle("margin", -0.5 * minWidth + "px 0 0 0 !important") : this.container.restyle("margin", -0.5 * a + "px 0 0 0 !important")) : e.isCenterPositioned() || (e.isTopPositioned() ? m.top = k + d + "px !important" : m.bottom = f + d + "px !important"), this.bubbleContainer &&
			...
			var Fa = M.extend({
				...
				createCanvasChatBubble: function () {
					var a, b, d, k, f, g, h, l, m, n, p, q, r, t, v, x, u, w = 5,
						y = e.chatBubble().bgc;
					if (a = this.bubbleContainer.getElementById("tawkchat-chat-bubble-canvas")) e.chatPosition(), a.width = "146", a.height = "85", f = a.getContext("2d"), f.clearRect(0, 0, 134, 63), f.fillStyle = y, e.isTopPositioned() ?
						(w = 16, g = 68, r = w + 3, q = 81, t = 6, v = !1, a = 1.1, b = 1.9, d = 1.6, k = 0.85) : (g = w = 6, r = w + 63 - 3, q = 55, t = 79, v = !0, a = 0.9, b = 0.1, d = 0.4, k = 1.15), e.isRTL() ? (u = 10, closeContainerStart = u - 4, h = u + 2, l = u + 5, m = u - 2, n = u - 2, p = u + 5, q = 81, e.isTopPositioned() ? (x = v, d = 0.2, k = 1.45) : (x = !v, d = 0.6, k = 1.85)) : (u = 2, closeContainerStart = u + 134 + 4, h = u + 134 - 2, l = u + 134 - 5, m = u + 134 + 2, n = u + 134 + 2, p = u + 134 - 5, x = v), f.beginPath(), f.moveTo(u + 8, w), f.lineTo(68, w), f.lineTo(u + 134 - 8, w), f.quadraticCurveTo(u + 134, w, u + 134, w + 8), f.lineTo(u + 134, w + 63 - 8), f.quadraticCurveTo(u + 134, w + 63, u + 134 - 8,
							w + 63), f.lineTo(u + 8, w + 63), f.quadraticCurveTo(u, w + 63, u, w + 63 - 8), f.lineTo(u, w + 8), f.quadraticCurveTo(u, w, u + 8, w), f.strokeStyle = "#e3e0e7", f.lineWidth = 2, f.stroke(), f.closePath(), f.fill(), f.beginPath(), f.arc(68, r, 10, Math.PI * a, Math.PI * b, v), f.strokeStyle = "#e3e0e7", f.lineWidth = 2, f.stroke(), f.fill(), e.isDesktopRectangle() || (e.isTopPositioned() && e.isLeftPositioned() ? q -= 30 : e.isBottomPositioned() && e.isRightPositioned() ? q += 30 : e.isCenterPositioned() && e.isRightPositioned() && (q += 30)), f.beginPath(), f.arc(q, t, 5, 0, 2 * Math.PI, !1), f.strokeStyle = "#e3e0e7", f.lineWidth = 2, f.stroke(), f.closePath(), f.fill(), f.beginPath(), f.arc(h, g + 5, 10, Math.PI * d, Math.PI * k, x), f.strokeStyle = "#e3e0e7", f.lineWidth = 2, f.stroke(), f.closePath(), f.fillStyle = y, f.fill(), f.beginPath(), f.moveTo(l, g + 1.5), f.lineTo(m, g + 8), f.closePath(), f.lineWidth = 2, f.strokeStyle = e.chatBubble().fgc, f.stroke(), f.beginPath(), f.moveTo(n, g + 1.5), f.lineTo(p, g + 8), f.closePath(), f.lineWidth = 2, f.strokeStyle = e.chatBubble().fgc, f.stroke()
				}
			});
			...
			var W = TawkClass.extend({
				init: function (a, c) {
					...
					e.maximizedDimensions.subscribe(function (a) {
						e.isEmbedded || (e.isPopup || y) || (d.frameHeight = a.height + "px", d.frameWidth = a.width + "px", d.container.restyle("height", d.frameHeight + " !important"), d.container.restyle("width", d.frameWidth + " !important"))
					});
					...
					e.desktopWidget.subscribe(function () {
						e.isDesktopRectangle() ? (d.wrapper.removeClass("roundWidget"), d.container.documentRef.getElementById("minimizeChat").className = "headerBoxLink", "br" === e.chatPosition() ? d.container.documentRef.body.className = "right" :
				...
				toggleRatingAction: function () {
					var a = this.container.getElementById("rateMainWrapper"),
						c = this.container.getElementById("rateContainer");
					a && c && (e.showRating() ? (a.style.display = "block", this.container.attachUserEventListener("mouseover", function () {
								c.style.display = "block"
							},
				...
				toggleEmojiAction: function () {
					...
					e.showEmoji() ? (f.innerHTML = t.loader, d.style.display = "block", n.addClass(c, "with-emoji"), "undefined" === typeof H && Wa(this.container.documentRef), this.container.attachUserEventListener(b.viewHandler.clickEvent, function (c) {
						...
						f && ("function" === typeof f.contains ? f.contains(c) || a.closeEmojiSelection() : n.isDescendent(f, c) && a.closeEmojiSelection())
				...
				attachEvents: function () {
					...
					this.container.attachUserEventListener(b.viewHandler.clickEvent, function (c) {
						e.isPopup ? g.close() : (b.eventHandler.cancelEvent(c), b.sessionHandler.notifyWindowState("min"), a.closeMenu())
					...
					if (y) {
						...
						f && (fb.initElement(f, function (d, e) {
							5E3 >= e.length ? (c.className = "", a.isActionsContainerNotifShown = !1) : (c.className = "visible", a.isActionsContainerNotifShown = !0);
						...
						e = b.eventHandler.getTargetElement(d);
						setTimeout(function () {
			...
			W.prototype.toggleWebRTCActions = function () {
				if (this.inDocument) {
					var a = "none",
						b = "none",
						d = "none";
					e.webRTCSettings() && e.webRTCSettings().en && (a = e.webRTCSettings().v ? "inline-block" : "none", b = "inline-block", d = e.webRTCSettings().s ? "inline-block" : "none");
			...
			W.prototype.setChatGreetings = function (a) {
				...
				(c = r.pageStatus()) && (e && d) && (c = m.getLongMessage(c), a && !c ? (e.className += " no-content", e.style.display = "none") : (d.innerHTML = c.replace(n.regLineBreaks, n.br), 1 > b.agents.agentsCount && (e.style.display = "block"), a || (e.className = e.className.replace(" minimize", ""))))
			};
				...
				init: function () {
					...
					if (!e.isPopup &&
						...
						var c = [p.container, p.chatIndicator, p.bubbleContainer, this.overlayElement],
							d;
						e.isDesktopRectangle() ? d = [this.resizeFromLeft, this.resizeFromRight, this.resizeFromTop, this.resizeFromBottom, this.resizeTopLeft, this.resizeTopRight, this.resizeBottomLeft, this.resizeBottomRight] : (d = [], e.isRightPositioned() ? d.push(this.resizeFromLeft) : d.push(this.resizeFromRight), e.isCenterPositioned() ? (d = d.concat([this.resizeFromBottom, this.resizeFromTop]), d = e.isRightPositioned() ? d.concat([this.resizeTopLeft,
							this.resizeBottomLeft
						]) : d.concat([this.resizeTopRight, this.resizeBottomRight])) : e.isTopPositioned() ? (d.push(this.resizeFromBottom), e.isRightPositioned() ? d.push(this.resizeBottomLeft) : d.push(this.resizeBottomRight)) : (d.push(this.resizeFromTop), e.isRightPositioned() ? d.push(this.resizeTopLeft) : d.push(this.resizeTopRight)));
			...
			F.prototype.calculateWidgetPosition = function () {
				...
				e.isTopPositioned() ? (f.bottom = "auto", f.top = a + "px") : (e.isCenterPositioned() ? f.bottom = e.isDesktopRectangle() ? "0px" : d + "px" : f.bottom = a + "px", f.top = "auto");
			...
			F.prototype.maximizeWidget =
				function () {
					...
					if (!y && this.chatContainer.getElementById("chatTextarea") && "max" === r.chatWindowState() && !b.formHandler.currentForm && b.viewHandler.userAction) {
						var d = n.getDocument(n.getDocument(g).getElementById(f.container.elementId));
						if (d &&
			...
			F.prototype.insertPopupStyle =
				function () {
					...
					d.styleSheet ? d.styleSheet.cssText = f.nodeValue : d.appendChild(f);
					c.appendChild(d);
					a.appendChild(c);
			...
			F.prototype.begin = function () {
				...
				b.main.started || (this.iframeContainer && (d = document.getElementById(this.iframeContainer.elementId)),
					d && d.parentNode.removeChild(d), e.isEmbedded && c ? (c.appendChild(this.iframeContainer.elementReferrer), b.eventHandler.listen(g, "resize", function () {
			...
			F.prototype.adjustEmojiContainerHeight = function () {
				var a = this.chatContainer.documentRef.getElementById("emoji-selection-container"),
					...
					b = b.clientHeight - d.clientHeight - e.clientHeight;
			...
			F.prototype.setResizedDimensions = function (a, c, d) {
				...
				if (c) {
					...
					var l = parseInt(n.computedStyle(this.chatContainer.elementReferrer, "width").replace("px", ""), 10),
						...
						p = 0 > p ? 0 : p;
					this.isRight && "right" === c || !this.isRight && "left" === c ? (c = l - (p - m), 280 > c ? c = 280 : (p > this.actualViewPortWidth - c - 1 && (p = this.actualViewPortWidth - c - 1), g.style.cssText += ";" + f + ":" + p + "px !important", this.startOffsetX = c)) : this.startOffsetX = c = this.isRight ? this.actualViewPortWidth - a.clientX - m : a.clientX - m;
					280 <= c && 0 < this.actualViewPortWidth - (c + parseInt(n.computedStyle(g, f).replace("px", ""), 10)) && this.setWidth(c)
				}
			...
			F.prototype.setChatWindowXPosition = function (a) {
				var b, d, k = parseInt(f.frameWidth.replace("px", ""), 10);
			...
			F.prototype.setChatWindowYPosition = function (a) {
				var b, d, e = parseInt(f.frameHeight.replace("px", ""), 10);
			...
			F.prototype.onWindowResizeTimeout = function () {
				var a = this.getActualViewportDimensions(),
					...
					e = this.isBottom ? parseInt(d.style.bottom.replace("px", ""), 10) : parseInt(d.style.top.replace("px", ""), 10),
				...
				l + e > a && (e = a - l, 0 > e && (l += e, e = 0, this.setHeight(l)),
					this.isBottom ? d.style.bottom = e + "px" : d.style.top = e + "px");
			...
			F.prototype.resetView = function () {
				var a, b, d, e, f;
				if (e = this.chatContainer) a = e.getElementById("chatWrapper"), d = e.getElementById("agentList"),
					f = e.getElementById("agentBar"), e = e.getElementById("expandableLink"), a && (b = a.lastChild, a.innerHTML = "", a.appendChild(b)), d && (d.innerHTML = ""), f && (a = f.parentNode.childNodes[0], f.className = "", a && -1 !== a.className.indexOf("agentWrapper") && a.parentNode.removeChild(a)), e && (e.style.visibility = "hidden", e.className = ""), this.show()
			};
			...
			var jb =
				...
				ia = function () {
					...
					e.isCenterPositioned() && "rectangle" === e.mobileWidget() && (e.isRightPositioned() ? (c.transform =
			...
			var B = function (a) {
				...
				arguments.length && (this.browser = a, this.metaContent = this.getMetaContent(), this.landscape = !1, this.zoom = 1, this.resizeTimeout = this.hasKeyboard = this.minAndMaxScalesAreEqual = this.hasViewportHeightWidth = this.hasInitialScale = !1, this.removeAgentNotification = !0, this.clickEvent = "touchend", this.hasChatStarted = this.isMaximized = this.isBottomWidget = !1, this.originalDocumentStyle = null, this.isTherePreChat = e.showPreChatForm, this.noZoomMetaTag =
					...
					this.indicator = new oa(this.minifiedWidget.container), this.iframeContainer.addChildViews([this.minifiedWidget.container, f.container]), "#max-widget" === g.location.hash && (g.history ? g.history.replaceState({}, document.title, ".") : g.location.hash = ""), this.iframeContainer.buildView(), this.chatContainer = f.container, b.eventEmitter.on("resizeIframeHeight", function () {
						...
						e.isPopup || (c.hideWidget(), "max" === a ? (l.disableMobileBackHistory || g.location.hash && "#max-widget" !== g.location.hash || (g.history.pushState ? g.history.pushState(null, null, g.location.href + "#max-widget") : g.location.hash = "max-widget"), c.maximize()) : (l.disableMobileBackHistory || "#max-widget" === g.location.hash && g.history.back(), c.isMaximized = !1, c.show()))
					}), r.pageStatus.subscribe(function (a) {
					...
					e.mobileWidget.subscribe(function () {
						...
						c.chatContainer && c.chatContainer.elementReferrer && c.chatContainer.insertCssFile(e.maxStyle(), !0)
			...
			B.prototype.checkMetaContent = function () {
				var a, b = {},
					d = this.metaContent;
				if (d) {
					for (var d = d.replace(/ /g, ""), d = d.split(","), e = 0, f = d.length; e < f; e++) a = d[e].split("="), b[a[0]] = a[1];
			...
			B.prototype.resizeHandler = function () {
				...
				"offline" === r.pageStatus() && e.hideWidgetOnOffline ||
					this.isMaximized || (clearTimeout(this.resizeTimeout), this.resizeTimeout = setTimeout(function () {
						var b = a.isLandscape(),
							d = a.ifScrollbarDown();
						"offline" === r.pageStatus() && e.hideWidgetOnOffline || (a.landscape !== b && d && setTimeout(function () {
							a.scrollToBottom()
			...
			B.prototype.getMetaContent = function () {
				...
				for (b = d.length; a < b; a++) d[a].getAttribute("name") &&
					"viewport" === d[a].getAttribute("name").toLowerCase() && (e = d[a].getAttribute("content"));
				return e
			};
			...
			B.prototype.resizeMobileRectangleWidget = function () {
				...
				"rectangle" === e.mobileWidget() && (a.style.width = "", this.minifiedBoxWidth = a.offsetWidth + 41, 110 > this.minifiedBoxWidth ? this.minifiedBoxWidth = 110 : !this.isLandscape() && this.minifiedBoxWidth > screen.width ? (this.minifiedBoxWidth = screen.width - 41, a.style.width = "calc(100% - 41px)") : this.isLandscape() && this.minifiedBoxWidth >
					f && (this.minifiedBoxWidth = f - 41, a.style.width = "calc(100% - 41px)"), !this.isLandscape() && this.minifiedBoxWidth > screen.width - 41 ? this.minifiedBoxWidth = screen.width - 41 : this.isLandscape() && this.minifiedBoxWidth > f - 41 && (this.minifiedBoxWidth = f - 41 - 10), d.style.width = this.minifiedBoxWidth + "px", e.isRTL() ? b.style.right = this.minifiedBoxWidth - 17 + "px" : b.style.left = this.minifiedBoxWidth - 17 + "px")
			};
			B.prototype.scaleContent = function (a) {
				if (!this.isMaximized) {
					...
					a && g && (d = Math.ceil(d * a) + 15 * a, f = Math.ceil(f * a) + 15 * a, this.minifiedWidget.container.massRestyle({
						height: d +
							"px !important",
			...
			B.prototype.updateWidgetPosition = function (a) {
				...
				this.iframeContainer && (e.isCenterPositioned() ?
					(b.top = "50% !important", b.bottom = "auto !important", b.margin = this.isMinifiedRound ? -0.5 * a + "px 0 0 0 !important" : -0.5 * a - (this.defaultHeight - 37) / 2 + "px 0 0 0 !important") : (b.margin = "0 !important", e.isTopPositioned() ? (b.top = "0px !important", b.bottom = "auto !important", d.top = this.isMinifiedRound ? "5px !important" : "-26px !important") : (b.bottom = "0px !important", b.top = "auto !important", d.bottom = this.isMinifiedRound ? "14px !important" : "0px !important")), e.isRightPositioned() ? (b.right = "0px !important", b.left = "auto !important",
			...
			B.prototype.addOverflowScroll = function (a) {
				...
				b.eventHandler.listen(a, "touchmove", function (e) {
					...
					20 >= e.touches[0].pageY || 0 > c - e.touches[0].pageY || (a.scrollTop = c - e.touches[0].pageY, f.isScrollbarDown = d.ifScrollbarDown())
			...
			B.prototype.renderAgentMinimizedWidget = function (a) {
				...
				if (a) {
					if (a = w.agentProfiles[a], a = a.pi ? r.agentImgUrl + "/" + a.pi : "") "round" === e.mobileWidget() && (d.style.display = "none"), b.style.backgroundImage = "url('" + a + "')", f.style.display = "block"
				} else d.style.display = "inherit", b.style.backgroundImage = null, f.style.display = "none"
			};
			...
			ma.prototype.calculate = function () {
				...
				if (e.schedule)
					if (0 === e.schedule.length) this.goOffline();
						...
						void 0 !== f ? (this.goOnline(), f = 60 * f.end - d) : (this.goOffline(), f = void 0 !== g ? 60 * g.start - d : 86400 - d + 1);
			...
			Z.prototype.prepareData = function () {
				...
				if (b) {
					...
					if (-900 > d || 900 < d) d = 0;
					this.registerData ? (this.registerData.k = c, this.registerData.d = g) : (f = b.browserData.getReferredSearchEngine(),
						this.registerData = {
							a: K.pageId || "",
							k: c,
							w: e.widgetId,
			...
			Z.prototype.getUUID = function () {
				...
				for (var l = 0, m = a.length; l < m; l++) {
					...
					if (4 === r.length)
						...
						} else "p" === n && (n = h.match(p)) && (h.substr(n.index) === p && n.index < f) && (f = n.index, c = q, d = r, e = !0)
				}
			...
			Z.prototype.doRegister = function () {
				...
				this.previousRegisterCall = Na.xhrRequest(a, this.registerData,
					function (a, e) {
						if (!a && !e) return c.clearTimers(), c.retryRegister();
			...
			na.prototype.processSettings = function (a) {
				...
				if (!(a.wv < e.widgetVersion)) {
					...
					e.isDesktopRectangle() && (c = parseInt(a.minw, 10) || 320, d = parseInt(a.minh, 10) || 40);
					e.chatBubble(a.bbl);
					...
					b && (c = ".theme-background-color{background-color: " + e.headerBgColor + ";}", d = ".theme-text-color{color: " + e.headerTxtColor + ";}", e.showEmoji() && (g +=
						...
						"px !important; border-top-right-radius:" + e.topCorner + "px !important;}", l = l + c + d, l += ".border-corner{border-radius : " + f + "-moz-border-radius : " + f + "-webkit-border-radius : " + f + "}", l += topBorderRadius, l += bottomBorderRadius, l += "#tooLongMsgNotification {background-color: " + e.headerBgColor + "; color : " + e.headerTxtColor + "}", l += "#file-upload-drop-icon {color:" + e.headerBgColor + ";}", l += "#tawkchat-status-container{left: 10px;}", l += "#short-message, #maximizeChat, #minimizeChatMinifiedBtn{line-height: " + e.minimizedDimensions().height +
						"px;}", l += ".bubble-text-color{color:" + (e.chatBubble() ? e.chatBubble().fgc : "#ffffff") + ";}", l += "#tawkchat-message-preview-messages-container .messageBody {background-color: #fff !important; color : #333 !important;}", l += "#textareaContainer.additionalPadding{padding-right: " + g + "px;}", l += ".rtl-direction #textareaContainer.additionalPadding{padding-left: " + g + "px;padding-right: 14px;}", l += "#chat-icon-svg { fill:" + e.headerTxtColor + "};", e.minStyle(l), b.MinifiedStyle += " " + b.CommonStyle), b.MaximizedStyle && (c =
						".theme-background-color{background-color: " + e.headerBgColor + ";}", d = ".theme-text-color{color: " + e.headerTxtColor + ";}", h = h + c + d, h += "#tooLongMsgNotification {background-color: " + e.headerBgColor + "; color : " + e.headerTxtColor + "}", h += "#file-upload-drop-icon {color:" + e.headerBgColor + ";}", h += "#chatMenuControls li:hover {background-color: " + e.headerBgColor + ";color: " + e.headerTxtColor + "}", h += "#formContainer>#emailTranscriptForm .form-header-icon, #changeNameForm .form-header-icon, #chatEndedForm .form-header-icon, #preChatForm .longFormContainer .form-header-icon {background-color:" +
			...
			U.prototype.handlePrechatSave = function (a, c) {
				...
				if (0 < a.questions.length)
					for (d = 0, e = a.questions.length; d < e; d++) f += n.rawDecode(a.questions[d].label) + " : " + a.questions[d].answer, d !== e - 1 && (f += "\r\n");
			...
			J.prototype.parseHistory = function (a) {
				...
				w.chatEndVersion = 1;
				c = 0;
				for (d = w.chatHistory.length; c < d; c++) "CHAT_ENDED" === w.chatHistory[c].m && (f = c + 1, w.chatEndVersion++);
				g = 0 < w.chatOrder ? this.messages[w.chatOrder] : null;
				c = f;
				for (d = w.chatHistory.length; c <
					d; c++) f = w.chatHistory[c], f.md && (!f.md || f.md.ao) || a && g && g.timeStamp > (new Date(f.co)).getTime() || ("v" !== f.ut || (this.visitorHasMessaged || "c" !== f.t) || (h = (new Date).getTime() - n.getMilliseconds(f.co)), "WEBRTC_CALL" === f.m && f.md && f.md.webrtc ? (this.hasWebRTCall = !0, b.viewHandler.subscribeCallUpdate(f.md.clid, !0)) : this.prepareMessage(f, !0, !1, !1));
				this.noRedraw = !1;
			...
			J.prototype.handleMessageFromServer = function (a) {
				...
				"WEBRTC_CALL" === a.m && a.md && a.md.webrtc ? this.hasWebRTCall = !0 : "CHAT_ENDED" !== a.m || this.hasChatEnded ? ("v" ===
					a.ut && "c" === a.t && b.viewHandler.addWaitTime(), e.isPopup || ("c" !== a.t || b.viewHandler.isMaximized || "v" === a.ut || e.isEmbedded || !y) || (b.viewHandler.hasChatStarted = !0), w.chatVersion = a.cver, "s" === a.ut || ("c" !== a.t || this.hasChatStarted()) || (this.hasChatStarted(!0), l.triggerApiHandlers("onChatStarted", {
						chatId: w.chatId
			...
			J.prototype.prepareMessage = function (a, c, d, e) {
				...
				"n" === a.t && "v" === a.ut ? "VISITOR_RATING" ===
					a.m && this.changeRating(a.md.rt, !0) : ("v" === a.ut ? (f = D.displayName(), g = a.uid) : (f = a.n, "a" === a.ut ? g = w.profiles[a.md.rsc] : "s" === a.ut && a.md && (l = a.md.pi)), "n" !== a.t || "AGENT_JOIN_CONVERSATION" !== a.m && "AGENT_LEFT_CONVERSATION" !== a.m || (m = !1, b.agents.updateAgentPresence(a.m, a.md, a.n, a.md.rsc, !d)), m && (h || (h = this.parseText(a.m)), void 0 === c && (c = !0), a.timeStamp = (new Date(a.co)).getTime(), a.messageId = b.viewHandler.appendMessage({
						message: h,
						name: f,
						type: a.t,
						time: a.co,
					...
					}), e || w.chatOrder++, this.messages[w.chatOrder] = a))
			};
			...
			J.prototype.createUrl = function (a, c) {
				...
				var f, g, h;
				g = 0;
				for (h = a.length; g < h; g++) - 1 !== a[g].indexOf(n.br) ? (f = a[g].split(n.regBr), a[g] = this.createUrl(f, n.br)) : a[g].match(n.regEmailMatch) ?
					a[g] = a[g].replace(n.regEmailMatch, e) : (a[g] = a[g].replace(n.regMatchUrl, d), a[g] = a[g].replace(n.regMatchIp, d));
				return a.join(c)
			};
			...
			J.prototype.conversationUpdate = function (a) {
				...
				if (!(w.chatVersion >= f)) {
					a = 0;
					for (c = d.length; a < c; a++) d[a].cver > f && g.push(d[a]);
					a = 0;
			...
			J.prototype.sendFileMessage = function (a) {
				...
				b.socketManager.sendToConnector("fileUploadMessage", d, function (e, f, g) {
					e || (b.viewHandler.fileUploaded(a.handle), d.fileName = n.rawEncode(d.fileName), messageId = b.viewHandler.appendMessage({
						message: "FILE",
						name: D.displayName(),
						type: "c",
						time: f,
			...
			X.prototype.init = function () {
				var a, c;
				if ("XMLHttpRequest" in g && "withCredentials" in new XMLHttpRequest && (u.cookieEnabled && !this.isDocumentReady) && (this.isDocumentReady = !0, c =
					...
					aa();
					l.isPopup && (r.transferKey = c.$_tawk_tk, r.sessionKey = c.$_tawk_sk, e.isPopup = !0);
			...
			X.prototype.extractRegisterData = function (a) {
				a.wdgt && (a.wdgt.lc !== x.widgetSettings.lc && (this.waitingForLanguage = !0, n.insertScript("https://static-v.tawk.to/689/languages/" + a.wdgt.lc + ".js")), m.processSettings(a.wdgt));
			...
			X.prototype.criticalRefresh = function (a, c, d) {
				...
				if (e.isPopup) return g.location.reload(!!c);
				this.dataIsReady = this.viewIsReady = !1;
				this.removeWidget();
				c && (l += "restarted=true&");
				d && (l += "maximized=true&");
